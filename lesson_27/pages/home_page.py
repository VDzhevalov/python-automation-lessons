...
from lesson_27.helpers.auth_helper import AuthHelper
...
class HomePage:
    ...
    def click_sign_up_button_by_xpath(self):
        self.get_sign_up_button_by_xpath().click()
        return self

    def click_sign_up_button_by_css(self):
        self.get_sign_up_button_by_css().click()
        return self

    def click_sign_up_button_by_css_attr_ends(self):
        self.get_sign_up_button_by_css_attr_ends().click()
        return self

    def click_sign_in_button_by_complex_css(self):
        self.get_sign_in_button_by_complex_css().click()
        return self

    def click_sign_up_button_by_class_name(self):
        self.get_sign_up_button_by_class_name().click()
        return self